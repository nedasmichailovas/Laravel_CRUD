    ...
    <form action="{{ route('students.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="phone"
                   ...
                   value="{{ old('phone') }}" placeholder="+37061234567"required>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="asmens_kodas"
                   ...
                   value="{{ old('asmens_kodas') }}" placeholder="pvz. 39001010005">
        ...
        <button type="submit" class="btn btn-success">Issaugoti</button>
    </form>
  </div>
</div>
